import { BoundingRegion, Polygon, StudioFieldValue, StudioSpan } from "../../models/analyzeResult/page";
...
export const getFieldTypeValue = (field: StudioFieldValue) => {
    ...
    const dynamicKey = `value${typeString}` as keyof StudioFieldValue;
    return field[dynamicKey];
};
